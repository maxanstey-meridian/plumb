...
export function defineRepositoryRule(options) {
  return defineRule("repository", options.descriptor, options.requirements ?? [], options.analyze);
}
...
export function defineFileRule(options) {
  ...
  return defineRule("file", options.descriptor, options.requirements ?? [], options.analyze, { files: options.files });
}
